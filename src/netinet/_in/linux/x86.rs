...
impl in6_addr {
    pub fn addr8(&self) -> &[u8; 16] {
        unsafe { ::std::mem::transmute(self) }
    }

    pub fn addr16(&self) -> &[u16; 8] {
        unsafe { ::std::mem::transmute(self) }
    }

    pub fn addr32(&self) -> &[u32; 4] {
        unsafe { ::std::mem::transmute(self) }
    }

    pub fn addr8_mut(&mut self) -> &mut [u8; 16] {
        unsafe { ::std::mem::transmute(self) }
    }

    pub fn addr16_mut(&mut self) -> &mut [u16; 8] {
        unsafe { ::std::mem::transmute(self) }
    }

    pub fn addr32_mut(&mut self) -> &mut [u32; 4] {
        unsafe { ::std::mem::transmute(self) }
    }
}
