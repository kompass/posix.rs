...
extern {
    ...
    pub fn erand48(xsubi: [ushort_t; 3]) -> double_t;
    ...
    pub fn jrand48(xsubi: [ushort_t; 3]) -> long_t;
    pub fn l64a(n: long_t) -> *mut char_t;
    pub fn labs(x: long_t) -> long_t;
    pub fn lcong48(param: [ushort_t; 7]);
    ...
    pub fn nrand48(xsubi: [ushort_t; 3]) -> long_t;
    ...
    pub fn seed48(seed16v: [ushort_t; 3]) -> *mut ushort_t;
